...
import com.sparta.is.init.ModTileEntities;
...
public class TileEntityIS extends TileEntity implements ITickable, ITileEntityIS
{
...
//        orientation = EnumFacing.SOUTH;
    ...
    {
        LogHelper.info("\t\t[Block] Initializing model: " + customName);
