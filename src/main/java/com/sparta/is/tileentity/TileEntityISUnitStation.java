...
public class TileEntityISUnitStation extends TileEntityInventoryBase implements IInventory
{
    ...
    {
        super(1, Names.TileEntities.IS_UNIT_STATION);
...
//    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbtTagCompound)
    {
        ...
        nbtTagCompound.setTag("Unit", tagList);
        ...
        for (int currentIndex = 0; currentIndex < inventory.length; ++currentIndex)
        {
            if (inventory[currentIndex] != null)
            {
                ...
                tagCompound.setTag("item", inventory[currentIndex].writeToNBT(tagCompound));
                tagList.appendTag(tagCompound);
            }
    ...
    public void readFromNBT(NBTTagCompound nbtTagCompound)
    {
        ...
        if(nbtTagCompound.hasKey("Unit", 9))
        {
            NBTTagList tagList = nbtTagCompound.getTagList("Unit", 10);
        ...
        for (int i = 0; i < tagList.tagCount(); ++i)
        {
            ...
            {
                inventory[slotIndex] = new ItemStack(tagCompound.getCompoundTag("item"));
            }
        }
    }
