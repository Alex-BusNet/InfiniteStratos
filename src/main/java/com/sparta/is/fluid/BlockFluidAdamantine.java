...
public class BlockFluidAdamantine extends BlockFluidIS
{
    ...
    public BlockFluidAdamantine(Fluid fluid)
    {
        super(fluid, Materials.adamantineFluidMaterial, "is", "adamantine");
    ...
    public int getLightValue(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        return ModFluids.fluidAdamantine.getLuminosity();
    }
    ...
    {
        LogHelper.info("Registering Adamantine fluid...");
        this.setRegistryName("fluid_adamantine");
