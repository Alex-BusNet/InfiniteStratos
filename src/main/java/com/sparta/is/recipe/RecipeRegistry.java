...
import com.sparta.is.reference.Comparators;
import com.sparta.is.utils.LoaderUtils;
...
{
    public static final Marker RECIPE_MARKER = MarkerManager.getMarker("IS_RECIPE", LogHelper.MOD_MARKER);
