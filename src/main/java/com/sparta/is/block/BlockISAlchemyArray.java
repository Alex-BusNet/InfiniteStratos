...
import com.sparta.is.reference.Sounds;
...
import com.sparta.is.utility.CommonSoundHelper;
...
public class BlockISAlchemyArray extends BlockTileEntityIS
{
    public BlockISAlchemyArray()
    {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
        if (!world.isRemote && world.getTileEntity(x, y, z) instanceof TileEntityAlchemyArray && entityLiving instanceof EntityPlayer)
        {
            ...
            if (alchemyArray != null)
            {
                ...
                ((TileEntityIS) world.getTileEntity(x, y, z)).setOrientation(world.getBlockMetadata(x, y, z));
