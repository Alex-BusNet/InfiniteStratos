...
public class ISModelRenderer extends ModelRenderer
{
    ...
    public ISModelRenderer(ModelBase modelbase, String s)
    {
        super(modelbase, s);
        flip = false;
        compiled = false;
    ...
    public ISModelRenderer(ModelBase modelbase)
    {
        this(modelbase, null);
    }

    /**
     * Creates a new ISModelRenderer object. It requires the coordinates of the
     * position of the texture.
     * @param modelbase
     * @param textureX the x-coordinate on the texture
     * @param textureY the y-coordinate on the texture
     */
    public ISModelRenderer(ModelBase modelbase, int textureX, int textureY)
    {
     ...
     * @param textureV
     */
    public ISModelRenderer(ModelBase modelbase, int textureX, int textureY, int textureU, int textureV)
    {
        this(modelbase);
     ...
     */
    @Override
    public ISModelRenderer addBox(float x, float y, float z, int w, int h, int d)
    {
     ...
     */
    @Override
    public ISModelRenderer setTextureOffset(int x, int y)
    {
        textureOffsetX = x;
        textureOffsetY = y;
        return this;
