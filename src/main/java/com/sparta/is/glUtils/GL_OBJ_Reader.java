...
public class GL_OBJ_Reader
{
    ...
    public GL_OBJ_Reader(String objfilename)
    {  // Construct from file name
        loadobject(objfilename);
    }


    public GL_OBJ_Reader(InputStream in)
    {
    ...
    private float[] read3Floats(String line)
    {
        try
        {
            ...
            if ( st.countTokens() == 2 )
            { // texture uv may have only 2 values
