...
public class GLMaterialLib
{
    ...
    public GLMaterial[] loadMaterials(BufferedReader br)
    {
        ...
        {
            LogHelper.info("GLMaterialLib.loadMaterials() failed at line: " + line);
            e.printStackTrace();
        }
        // debug:
        LogHelper.info("GLMaterialLib.loadMaterials(): loaded " + mtlslist.size() + " materials ");
    ...
    private float[] read3Floats(String line)
    {
        ...
        {
            LogHelper.info("GLMaterialLib.read3Floats(): error on line '" + line + "', " + e);
        }
        return null;
    }
    ...
    public void writeLibe(GLMaterial[] mtls, String filename)
    {
        ...
        {
            LogHelper.info("GLMaterialLib.writeLibe(): IOException:" + e);
        }
    }
