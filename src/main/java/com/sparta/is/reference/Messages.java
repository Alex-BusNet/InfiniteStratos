...
public class Messages
{
    ...
    public static final String INVALID_OWNER = "misc.is:invalid-owner";
    ...
    public static final String INVALID_FINGERPRINT_MESSAGE = "The copy of Infinite Stratos that you are running has been modified from the original, and unpredictable things may happen. Please consider re-downloading the original version of the mod.";
    ...
    {
        private static final String TOOLTIP_PREFIX = "tooltip.is:";
