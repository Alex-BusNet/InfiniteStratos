...
public class BlockFluidIS extends BlockFluidClassic implements IInitializer, IModelRegister
{
    ...
    public BlockFluidIS(Fluid fluid, Material material, String modName, String name)
    {
    ...
    public BlockFluidIS(Fluid fluid, Material material, String name)
    {
        this(fluid, material, "is", name);
    }

    public BlockFluidIS setParticleColor(int c) {

        return setParticleColor(((c >> 16) & 255) / 255f, ((c >> 8) & 255) / 255f, (c & 255) / 255f);
    }

    public BlockFluidIS setParticleColor(float particleRed, float particleGreen, float particleBlue) {
    ...
    public BlockFluidIS setDisplaceFluids(boolean a) {
