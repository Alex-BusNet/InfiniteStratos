...
public class BlockFluidInteractiveIS extends BlockFluidIS
{
    ...
    public BlockFluidInteractiveIS(Fluid fluid, Material material, String name)
    {
        super(fluid, material, name);
    }

    public BlockFluidInteractiveIS(Fluid fluid, Material material, String modName, String name)
    {
