...
import com.sparta.is.core.exchange.OreStack;
...
public class RecipeHelper
{
    public static Set<WrappedStack> getRecipeInputs(IRecipe recipe) {
        ...
        if (recipe instanceof ShapedRecipes ) {
            ...
            if (validateOreDictionaryRecipe(Arrays.asList(shapedOreRecipe.getIngredients()))) {
                for (int i = 0; i < shapedOreRecipe.getIngredients().size(); i++) {
                    Object recipeInput = shapedOreRecipe.getIngredients().get(i);
...
//                    }
            ...
            if (validateOreDictionaryRecipe(shapelessOreRecipe.getIngredients())) {
                recipeInputs.addAll(shapelessOreRecipe.getIngredients().stream()
