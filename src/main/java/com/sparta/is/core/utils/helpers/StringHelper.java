...
public class StringHelper
{
    ...
    public static String shiftForDetails() {
        ...
        return LIGHT_GRAY + localize("info.is.hold") + " " + YELLOW + ITALIC + localize("info.is.shift") + " " + END + LIGHT_GRAY
                + localize("info.is.forDetails") + END;
    }

    /* TUTORIAL TAB HELPERS */
    public static String tutorialTabAugment() {

        return localize("info.is.tutorial.tabAugment");
    }

    public static String tutorialTabConfiguration() {

        return localize("info.is.tutorial.tabConfiguration.0");
    }

    public static String tutorialTabConfigurationEnergy() {

        return localize("info.is.tutorial.tabConfiguration.1");
    }

    public static String tutorialTabConfigurationOperation() {

        return localize("info.is.tutorial.tabConfiguration.2");
    }

    public static String tutorialTabRedstone() {

        return localize("info.is.tutorial.tabRedstone");
    }

    public static String tutorialTabSecurity() {

        return localize("info.is.tutorial.tabSecurity");
    }

    public static String tutorialTabFluxRequired() {

        return localize("info.is.tutorial.fluxRequired");
    }
