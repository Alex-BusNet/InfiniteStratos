...
import com.sparta.is.entity.driveables.EntitySeat;
...
public class PlayerHandler
{
    ...
    public PlayerHandler()
    {
        ...
        try {
            ...
            LogHelper.error("Couldn't find floatingTickCount field.", e);
        }
    }
    ...
    public void serverTick()
    {
        ...
        {
            LogHelper.warn("Receiving server ticks when server is null");
            return;
        }
