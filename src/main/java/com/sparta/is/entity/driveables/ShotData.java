...
public class ShotData
{
    ...
    {
        public InstantShotData(int slot, InfoType shotFrom, ShootableType shotType, int shooterID, Vector3f origin, Raytracer.BulletHit hitData, Vector3f hit, float damage, boolean isExtraBullet)
        {
            super(slot, shotFrom, shotType);
            this.shooterID = shooterID;
            this.origin = origin;
        ...
        public InstantShotData(int slot, InfoType shotFrom, ShootableType shotType, Entity shooter, Vector3f origin, Raytracer.BulletHit hitData, Vector3f hit, float damage, boolean isExtraBullet)
        {
        ...
        public Raytracer.BulletHit hitData;
